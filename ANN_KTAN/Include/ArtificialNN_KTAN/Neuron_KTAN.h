...
public:
    ...
    vector<double> weights; // Dynamic array of weights for each input
    vector<double> inputs;  // Dynamic array of inputs received by the neuron
